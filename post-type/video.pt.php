...
class Video {
    ...
    private $icon               = 'dashicons-video-alt3';
    ...
    public function register() {
        ...
        $slug = !empty($opt['video_slug']) ? strtolower(str_replace( ' ', '', $opt['video_slug'])) : $this->slug;
        $labels = array(
            'name'                  => esc_html_x( 'Videos', 'Post Type General Name', 'hovard-core' ),
            'singular_name'         => esc_html_x( 'Video', 'Post Type Singular Name', 'hovard-core' ),
