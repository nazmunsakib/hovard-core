...
function hovard_social_share() { ?>
    <div class="hovard-social-icon">
        <ul class="flex items-center gap-3">
            <li>
                <span class="font-medium text-shaft dark:text-white"><?php echo esc_html__( 'Share:', 'hovard-core' ); ?> </span>
            </li>
            <li><a class="duration-300 ease-in-out hover:text-sienna"
                   href="https://facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>"><i class="ti-facebook"></i></a>
            </li>
            <li><a class="duration-300 ease-in-out hover:text-sienna"
                   href="https://twitter.com/intent/tweet?text=<?php the_permalink(); ?>"><i class="ti-twitter"></i></a>
            </li>
            <li><a class="duration-300 ease-in-out hover:text-sienna"
                   href="https://www.pinterest.com/pin/create/button/?url=<?php the_permalink() ?>"><i
                            class="ti-pinterest"></i></a></li>
            <li><a class="duration-300 ease-in-out hover:text-sienna"
                   href="https://www.linkedin.com/shareArticle?mini=true&url=<?php the_permalink() ?>"><i
...
function hovardcore_social_links() {
	...
	<?php if ( ! empty( $opt['facebook'] ) ) { ?>
        <li><a href="<?php echo esc_url( $opt['facebook'] ); ?>"><i class="social_facebook" aria-hidden="true"></i></a>
        </li>
	<?php } ?>

	<?php if ( ! empty( $opt['twitter'] ) ) { ?>
        <li><a href="<?php echo esc_url( $opt['twitter'] ); ?>"><i class="social_twitter" aria-hidden="true"></i></a>
        </li>
	<?php } ?>

	<?php if ( ! empty( $opt['instagram'] ) ) { ?>
        <li><a href="<?php echo esc_url( $opt['instagram'] ); ?>"><i class="social_instagram"
                                                                     aria-hidden="true"></i></a></li>
	<?php } ?>

	<?php if ( ! empty( $opt['linkedin'] ) ) { ?>
        <li><a href="<?php echo esc_url( $opt['linkedin'] ); ?>"><i class="social_linkedin" aria-hidden="true"></i></a>
        </li>
	<?php } ?>

	<?php if ( ! empty( $opt['youtube'] ) ) { ?>
        <li><a href="<?php echo esc_url( $opt['youtube'] ); ?>"><i class="social_youtube" aria-hidden="true"></i></a>
        </li>
	<?php } ?>
	...
	<?php if ( ! empty( $opt['dribbble'] ) ) { ?>
        <li><a href="<?php echo esc_url( $opt['dribbble'] ); ?>"><i class="social_dribbble" aria-hidden="true"></i></a>
        </li>
	<?php }
}
	...
	if ( $is_social_share == '1' ) :
        ...
        <div class="blog_social text-center">
            ...
            <ul class="list-unstyled f_social_icon">
                <li><a href="https://facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank"><i
                                class="social_facebook"></i></a></li>
                <li><a href="https://twitter.com/intent/tweet?text=<?php the_permalink(); ?>" target="_blank"><i
                                class="social_twitter"></i></a></li>
                <li><a href="https://www.pinterest.com/pin/create/button/?url=<?php the_permalink() ?>" target="_blank"><i
