...
class Testimonial extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'testimonials_style_sec',
			[
				'label' => esc_html__( 'Testimonial style', 'hovard-core' ),
			]
		);
		...
		$this->add_control(
			'style',
			[
				'label'   => esc_html__( 'Select Testimonial style', 'hovard-core' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'1' => esc_html__( 'One Column', 'hovard-core' ),
					'2' => esc_html__( 'Tow Column', 'hovard-core' ),
				],
				'default' => '1',
			]
		);
