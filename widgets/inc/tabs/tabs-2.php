            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                foreach ( $tabs as $index => $item ) :
                    ...
                    $this->add_render_attribute( $tab_title_setting_key, [
                        'href' => '#hovard-tab-content-' . $id_int . $tab_count,
                        'class' => [ 'nav-link tab-item-title', $active ],
                        'id' => 'hovard'.'-tab-'.$id_int . $tab_count,
                        'role' => 'tab',
                        'aria-controls' => 'hovard-tab-content-' . $id_int . $tab_count,
                        'data-toggle' => 'tab',
        ...
        <div class="tab-content">
            ...
            foreach ( $tabs as $index => $item ) :
                ...
                $this->add_render_attribute( $tab_content_setting_key, [
                    ...
                    'id' => 'hovard-tab-content-' . $id_int . $tab_count,
                    'aria-labelledby' => 'hovard'.'-tab-'.$id_int . $tab_count,
                    'role' => 'tabpanel',
                ]);
                ?>
