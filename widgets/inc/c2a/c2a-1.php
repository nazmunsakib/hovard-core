        ...
        <div class="d-flex justify-content-between">
            <div class="left">
                ...
                <?php if ( !empty($settings['btn_label']) ) : ?>
                    <a class="icon_btn2 wow fadeInUp c2abtn" data-wow-delay="0.6s" <?php echo hovard_el_btn($settings['btn_url']) ?>>
                        <?php echo esc_html($settings['btn_label']) ?><i class="arrow_right"></i>
                    </a>
                <?php endif; ?>
            </div>
            <div class="right">
                <?php hovard_el_image($settings['featured_image'], 'call to action background shape'); ?>
            </div>
        </div>
    </div>
</section>