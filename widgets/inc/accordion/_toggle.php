...
if ( $settings['title'] ) :
    ...
    ?>
    <a class="toggle_btn <?php echo $collapse_class; ?>" data-toggle="collapse" href="#toggle-<?php echo $this->get_ID(); ?>" role="button" aria-expanded="<?php echo esc_attr($is_collapsed) ?>"
