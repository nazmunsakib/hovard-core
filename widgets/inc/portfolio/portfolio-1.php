...
<div x-data="{ tab: 'all'}">
    ...
    <div>
        <div class="p-tab-btn button-group filters-button-group flex gap-2.5 mb-7.5 pt-2.5">
			...
			foreach ( $project_cat as $cat ):
                ...
                <button
                        ...
                        :class="{ 'active bg-sienna !text-white' : tab === '<?php echo esc_attr( $cat->slug ); ?>' }"
                >
        ...
        <div class="gallery projects-grid flex flex-wrap gap-5">
			...
			$project = new WP_Query( array(
				...
				'orderby'        => 'menu_order',
				'order'          => 'ASC',
				'posts_per_page' => $settings['posts_per_query']
			) );
			...
			while ( $project->have_posts() ): $project->the_post();
				...
				?>
                <!-- Project item -->
                <div class="project-item <?php echo esc_attr( $terms_class ); ?>"
                     x-show="<?php echo esc_attr( $terms_tabs ); ?> || tab === 'all'">
                    <div class="group w-full h-full relative">
						<?php the_post_thumbnail( 'hovard_795x544', [ 'class' => 'w-full h-full' ] ); ?>
                        ...
                        >
                            <div class="text-center">
                                <a href="#"><i
                                            class="ti-search inline-block bg-sienna text-white text-title9 rounded-sm border-4 border-sandrift px-4 py-3 mb-7.5"></i></a>
                                <h4 class="font-rufina font-bold text-title4 text-rosewhite mb-2.5"><a
