            ...
            <div class="row">
                <div class="col-lg-7">
                    <video id="player_<?php the_ID(); ?>" class="video-js vjs-fluid vjs-default-skin"
                           ...
                           poster="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'hovard_671x411') ?>">
            ...
            while ( $videos->have_posts() ) : $videos->the_post();
                ...
                <div class="item">
                    <div class="gallery_inner_thumb">
                        <?php the_post_thumbnail('hovard_270x152'); ?>
