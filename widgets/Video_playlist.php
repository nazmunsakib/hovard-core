...
class Video_playlist extends Widget_Base {
    public function get_name() {
        return 'hovard_videos_playlist';
    }

    public function get_title() {
        return esc_html__( 'Video Playlist', 'hovard-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'doc_design_sec', [
                'label' => __( 'Preset Skin', 'hovard-core' ),
            ]
        );

        $this->add_control(
            'style', [
                'label' => esc_html__( 'Skin', 'hovard-core' ),
        ...
        $this->add_responsive_control(
            'sec_padding', [
                'label' => __( 'Section padding', 'hovard-core' ),
